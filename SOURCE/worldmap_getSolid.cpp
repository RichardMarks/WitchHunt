...
eMapFlags WORLDMAP :: getSolid (int iXpos, int iYpos)
{
...
eMapFlags WORLDMAP :: getSolidFromIndex (int index)
{
 return m_vpkLocations.at (index)->m_eSolid;
}
