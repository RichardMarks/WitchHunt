...
string WORLDMAP :: getName (int iXpos, int iYpos)
{
 string strFailed = "";
...
std::string WORLDMAP :: getNameFromIndex (int index)
{
 return m_vpkLocations.at (index)->m_strName;
}
